        ...
        <>
            {loading ? <h1 className="flex text-xl font-bold justify-center items-center"> Loading... </h1> : <div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    {
                        services.slice(0,3).map((service, index) => <div key={index} className="border border-black rounded-lg">
                            <div className="block rounded-lg p-4 shadow-lg ">
                                ...
                                <div className="mt-6 flex items-center justify-between gap-4 text-xs">
                                    ...
                                    <Link to={`/services/${service._id}`} className="px-3 py-2 bg-gray-500 text-white rounded-xl ">View Details</Link>
                ...
                <div className="flex justify-center mt-5">
                    <Link className="px-3 py-2  rounded-xl bg-gray-900 font-bold text-white" to='/services'>See More</Link>
                </div>
            </div>
            }
        </>
